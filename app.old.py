...
--
"""
ponder_text_penelope = "Penelope is pondering your request..."
ponder_text_mariecaissie = "Ma chère, Marie Caissie crée your image prompt"
...
async def extract_insight_and_masterpiece(texts):
    """
    Extracts 'Insight' and 'Penelope's Masterpiece' from Penelope's replies.
    """
    insight = ""
    masterpiece = ""
    for text in texts:
        ...
        if "Penelope's Masterpiece:" in text:
